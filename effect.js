...
$ ('document').ready (function () {
  ...
  $ (window).resize (function () {
    ...
    $ ('#b11').animate ({top: 240, left: vw - 175}, 100);
    $ ('#b22').animate ({top: 240, left: vw - 125}, 100);
    $ ('#b33').animate ({top: 240, left: vw - 75}, 100);
    $ ('#b44').animate ({top: 240, left: vw - 25}, 100);
    $ ('#b55').animate ({top: 240, left: vw + 25}, 100);
    $ ('#b66').animate ({top: 240, left: vw + 75}, 100);
    $ ('#b77').animate ({top: 240, left: vw + 125}, 100);
  });
  ...
  $ ('#story').click (function () {
    ...
    function msgLoop (i) {
      $ ('p:nth-child(' + i + ')')
        ...
        .done (function () {
          i = i + 1;
          $ ('p:nth-child(' + i + ')').fadeIn ('slow').delay (2999);
          if (i == 50) {
            $ ('p:nth-child(49)')
              .fadeOut ('slow')
              .promise ()
